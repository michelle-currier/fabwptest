...
<?php
  ...
  ?>  
<div class="howto"><?php echo sprintf(esc_html__('If contact form is missing from list then install our %s , submit required form, it will add that missing form in this list.','integration-for-contact-form-7-and-spreadsheets'),'<a href="https://wordpress.org/plugins/contact-form-entries/" target="_blank">Contact Form Entries</a>')?></div>
<?php
      }
?>
  </div>
